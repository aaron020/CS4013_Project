...
public class Menu {
    ...
    /**
     * Gets property tax info on a chosen property
     * @param p Arraylist of property
     * @return the property that property tax info is requested for
     */
    ...
    /**
     * Different categories that can be chosen when adding a property
     * @return String
     */
